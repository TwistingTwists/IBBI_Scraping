...
def make_nclt_StatusCauseurl(bench, sub_bench, year):
    ...
    bench = bench
    sub_bench = sub_bench
    nclt_StatusCauseList = "https://nclt.gov.in/status-of-cause-list?field_date_value%5Bvalue%5D%5Bday%5D=4&field_date_value%5Bvalue%5D%5Bmonth%5D=4&field_date_value%5Bvalue%5D%5Byear%5D=" + \
        yr + "&field_bench_target_id=" + bench + \
        "&field_bench_court_target_id_entityreference_filter=" + sub_bench
